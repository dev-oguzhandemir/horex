        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://facebook.com/horexnakliyat" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-horex-red transition-colors" aria-label="Facebook sayfamızı ziyaret et">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z" />
                </svg>
              </a>
              <a href="https://instagram.com/horexnakliyat" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-horex-red transition-colors" aria-label="Instagram sayfamızı ziyaret et">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <a href="https://twitter.com/horexnakliyat" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-horex-red transition-colors" aria-label="Twitter sayfamızı ziyaret et">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
