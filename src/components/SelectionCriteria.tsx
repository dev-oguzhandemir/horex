...
export default function SelectionCriteria() {
  ...
  return (
    <section className="py-20 bg-horex-gray overflow-hidden relative" ref={ref}>
      <div className="container mx-auto px-4">
            ...
            >
              <div className="flex flex-col sm:flex-row items-start space-y-4 sm:space-y-0 sm:space-x-4">
                ...
                <div className="min-w-0">
                  <h3 className="text-xl font-semibold mb-2 text-horex-black break-words">
                    {item.title}
                  </h3>
        ...
        <motion.div
          className="absolute -bottom-10 -left-10 w-40 h-40 bg-horex-red/5 rounded-full -z-10"
          initial={{ scale: 0 }}
          animate={mainControls}
          variants={{
            visible: { scale: 1 }
        ...
        />
        <motion.div
          className="absolute -top-20 -right-20 w-60 h-60 bg-horex-red/5 rounded-full -z-10"
          initial={{ scale: 0 }}
          animate={mainControls}
          variants={{
            visible: { scale: 1 }
