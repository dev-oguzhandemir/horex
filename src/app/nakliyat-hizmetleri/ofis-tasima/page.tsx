...
export const metadata: Metadata = {
  title: 'Ofis Taşıma - Horex Nakliyat',
  ...
  openGraph: {
    type: 'website',
    url: 'https://horex.com.tr/nakliyat-hizmetleri/ofis-tasima',
    title: `${serviceData.title} - Horex Nakliyat`,
    description: serviceData.metaDescription,
    ...
    images: serviceData.heroImage ? 
      ...
      [{
        ...
        width: 1200,
        height: 630,
        alt: 'Horex Nakliyat - Ofis Taşıma Hizmetleri',
      }],
    locale: 'tr_TR',
  },
}
