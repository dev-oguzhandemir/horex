...
export const metadata: Metadata = SEO.generateMetadata({
  ...
  canonical: 'https://horexnakliyat.com/nakliyat-hizmetleri/sigortali-tasimacilik',
...
export default function InsuredTransportation() {
  ...
  const serviceSchema = SEO.generateServiceSchema(
    ...
    'https://horexnakliyat.com/nakliyat-hizmetleri/sigortali-tasimacilik'
  );
  ...
  const breadcrumbSchema = SEO.generateBreadcrumbSchema([
    ...
    { name: 'Sigortalı Taşımacılık', url: 'https://horexnakliyat.com/nakliyat-hizmetleri/sigortali-tasimacilik' }
  ]);
