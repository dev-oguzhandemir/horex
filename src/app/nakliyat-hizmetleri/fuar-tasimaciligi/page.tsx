...
export const metadata: Metadata = {
  title: 'Fuar Taşımacılığı - Horex Nakliyat',
  ...
  openGraph: {
    type: 'website',
    url: 'https://horex.com.tr/nakliyat-hizmetleri/fuar-tasimaciligi',
    title: `${serviceData.title} - Horex Nakliyat`,
    description: serviceData.metaDescription,
    ...
    images: serviceData.heroImage ? 
      ...
      [{
        ...
        width: 1200,
        height: 630,
        alt: 'Horex Nakliyat - Fuar Taşımacılığı Hizmetleri',
      }],
    locale: 'tr_TR',
  },
}
...
const structuredData = {
  ...
  "hasOfferCatalog": {
    "@type": "OfferCatalog",
    "name": "Fuar Taşımacılığı Hizmetleri",
