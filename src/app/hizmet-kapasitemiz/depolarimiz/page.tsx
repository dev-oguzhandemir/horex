...
import serviceData from '@/data/service-capacity/depolarimiz.json'
import { generateServiceSchema, generateBreadcrumbSchema, generateImageSchema } from '@/components/SEO'

export const metadata: Metadata = {
  title: `${serviceData.title} | Güvenli Depolama Hizmetleri | Horex Nakliyat`,
...
export default function DepolarimizPage() {
