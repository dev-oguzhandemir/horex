...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `https://horex.com.tr/hizmet-kapasitemiz/araclarimiz`,
  },
  openGraph: {
    title: `${serviceData.title} | Horex Nakliyat`,
    description: serviceData.metaDescription,
    url: 'https://horex.com.tr/hizmet-kapasitemiz/araclarimiz',
...
export default function AraclarimizPage() {
  ...
  const serviceSchemaData = generateServiceSchema(
    ...
    'https://horex.com.tr/hizmet-kapasitemiz/araclarimiz'
  )
  ...
  const breadcrumbSchemaData = generateBreadcrumbSchema([
    ...
    { name: serviceData.title, url: 'https://horex.com.tr/hizmet-kapasitemiz/araclarimiz' },
  ])
