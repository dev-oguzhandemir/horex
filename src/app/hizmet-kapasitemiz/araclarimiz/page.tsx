...
import serviceData from '@/data/service-capacity/araclarimiz.json'
import { generateServiceSchema, generateBreadcrumbSchema, generateImageSchema } from '@/components/SEO'

export const metadata: Metadata = {
  title: `${serviceData.title} | Profesyonel Nakliyat Araç Filosu | Horex Nakliyat`,
  description: serviceData.metaDescription,
  keywords: serviceData.metaKeywords,
  alternates: {
    canonical: `https://horexnakliyat.com/hizmet-kapasitemiz/araclarimiz`,
  },
  openGraph: {
    title: `${serviceData.title} | Horex Nakliyat`,
    description: serviceData.metaDescription,
    url: 'https://horexnakliyat.com/hizmet-kapasitemiz/araclarimiz',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: serviceData.heroImage?.alt || 'Horex Nakliyat Profesyonel Araç Filosu',
      },
    ],
    locale: 'tr_TR',
    type: 'website',
...
export default function AraclarimizPage() {
  ...
  const serviceSchemaData = generateServiceSchema(
    ...
    'https://horexnakliyat.com/hizmet-kapasitemiz/araclarimiz'
  )
  ...
  const breadcrumbSchemaData = generateBreadcrumbSchema([
    ...
    { name: serviceData.title, url: 'https://horexnakliyat.com/hizmet-kapasitemiz/araclarimiz' },
  ])

  // Image schema data
  const imageSchemaData = generateImageSchema(
    `https://horexnakliyat.com${serviceData.heroImage?.src || '/images/og-image.jpg'}`,
    serviceData.heroImage?.alt || 'Horex Nakliyat Profesyonel Araç Filosu',
    1200,
    800
  )
